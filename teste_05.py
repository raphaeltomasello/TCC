...
poses1, frames1 = process_video('Roger Federer Serves from Back Perpsective in HD.mp4')
print(f"Primeiro vídeo processado. Total de poses capturadas: {len(poses1)}")

print("Processando o segundo vídeo...")
poses2, frames2 = process_video('Roger Federer Serves from Back Perpsective in HD.mp4')
